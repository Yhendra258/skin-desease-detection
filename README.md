# Deployment Model CNN (penyakit kulit)
...
1. Buka URL dengan browser, coba masukkan gambar yang ingin di prediksi.
1. Anda akan diberikan prediksi bahwa pada gambar tersebut terdapat pada halaman website.
